...
class LectureAdmin(admin.ModelAdmin):
    list_display = ('lecture_title', 'mentor_id', 'mentor_description', 'description', 'price', 'field')

# 세부 강의 DB
@admin.register(DetailLecture)
class DetailLecutreAdmin(admin.ModelAdmin):
    list_display = ('lecture_title', 'video_title', 'url')

# My 강의 DB
@admin.register(LectureList)
class LectureListAdmin(admin.ModelAdmin):
    list_display = ('lecture_title','user_id')
